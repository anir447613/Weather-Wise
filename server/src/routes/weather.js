...
const { fetchOpenMeteo, fetchOpenWeather, fetchWeatherAPI } = require('../utils/weatherClients');
...
try {
// prefer OpenWeather if key exists
if (process.env.OPENWEATHER_API_KEY) {
const json = await fetchOpenWeather(lat, lon, process.env.OPENWEATHER_API_KEY);
